	...
	<div class="col-xs-12" id="dashboard_tabs">
		...
		<?= $this->Form->create('Caso', array('action' => 'NewTicket', 'class' => 'form-horizontal', 'inputDefaults' => array('label' => false))); ?>
			...
			<div class="form-group">
				...
				<?= $this->Form->input('nivel', array('required' => 'required', 'class' => 'form-control', 'required' => 'required', 'label' => 'Nivel del Caso', 'div' => array('class' => 'col-xs-12 col-sm-12 col-md-6'), array('class' => 'col-sm-2 control-label'), 'type' => 'select', 'options' => $level, 'selected' => '3', 'empty' => 'Selecciona un Nivel')) ?>
			</div>
			<div class="form-group">
