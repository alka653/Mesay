<div class="modal fade" id="modal-mesay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		...
		<?= $this->Form->create('User', array('action' => 'SaveTecni', 'class' => 'form-horizontal', 'inputDefaults' => array('label' => false))); ?>
		<?php
			$disabled = "true";
		?>
	      	<div class="modal-body form-horizontal">
				...
				<div class="form-group">
					<?= $this->Form->input('apellidos', array('autocomplete' => 'off', 'class' => 'form-control', 'required' => 'required', 'placeholder' => 'Ingrese apellidos', 'label' => 'Apellidos:', array('for' => 'apellidos'), 'maxlength' => '20')) ?>
				</div>
				<div class="form-group">
			...
			<?= $this->Form->submit('Guardar', array('id' => 'UserSavTecniForm', 'class' => 'button btn btn-primary btn-label-center', 'div' => false, 'disabled' => $disabled)) ?>
...
<script type="text/javascript">
	$("#UserSaveTecniForm").submit(function(e){
